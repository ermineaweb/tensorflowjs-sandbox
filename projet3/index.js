...
const trainDataCsvUrl = "file:///home/romain/workspace/tensorflowjs/projet3/train.csv";
const testDataCsvUrl = "file:///home/romain/workspace/tensorflowjs/projet3/test.csv";
...
async function run() {
  ...
  model.add(tf.layers.dense({ inputShape: [numOfFeatures], units: 50, activation: "relu" }));
  model.add(tf.layers.dense({ inputShape: [50], units: 50, activation: "relu" }));
